...
fig.add_trace(go.Bar(name="DesisCen", x=windowType, y=[3065244.36, 1463248.92, 2062724.5, 2041280.4, 1937204.07], legendrank=1, width=widthAll
                     , marker_line_color='rgb(99,110,250)', marker_pattern_shape="."))
fig.add_trace(go.Bar(name="DesisSW", x=windowType, y=[30635560.52, 30094194.45, 31055213.25, 31169257.83, 16001392.57], legendrank=2, width=widthAll
                     , marker_line_color='rgb(255,161,90)', marker_pattern_shape="-"))
fig.add_trace(go.Bar(name="Desis", x=windowType, y=[30545075.4, 29811997.74, 30980630.5, 31137398.54, 16012225.69], legendrank=3, width=widthAll
...
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s2\singleWindow.pdf")
pio.write_image(fig, "E:\my paper\DesisPaper\Desis-Optimizing-Decentralized-Window-Aggregation\experiment\s2\singleWindow.svg")