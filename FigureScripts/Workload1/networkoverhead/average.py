...
fig.add_trace(go.Bar(name="Desis", x=[" "], y=[7], legendrank=2, marker_color='rgb(144,170,219)', width=[0.3]))
...
pio.write_image(fig, "E:\My Paper\DesisPaper\experiment/workload1NetworkOverheadAverage.pdf")