...
fig.add_trace(go.Bar(name="Desis", x=[" "], y=[20], legendrank=2, marker_color='rgb(144,170,219)', width=[0.3]))
fig.add_trace(go.Bar(name="Centralized", x=[" "], y=[23], legendrank=1, marker_color='rgb(168,208,141)', width=[0.3]))
...
fig.update_yaxes(range=[0,25], showline=True, linewidth=1, linecolor='black', mirror=True)
...
pio.write_image(fig, "E:\My Paper\DesisPaper\experiment/workload1NetworkOverheadMedian.pdf")