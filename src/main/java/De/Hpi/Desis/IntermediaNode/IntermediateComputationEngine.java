...
import De.Hpi.Desis.Dao.IntermediateTask;
...
public class IntermediateComputationEngine implements Runnable {
    ...
    private LinkedList<IntermediateTask> intermediateTasks;
     ...
     IntermediateComputationEngine(ConcurrentLinkedQueue<Window> resultQueue, ConcurrentLinkedQueue<Window> resultQueueFromLocal,
    ...
    public void run() {
        while (true) {
            if (!resultQueueFromLocal.isEmpty()) {
                ...
                Window window = resultQueueFromLocal.poll();
